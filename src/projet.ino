...
bool temperatureEleve=false,zoneInconue=false; 
...
void loop() 
{
 ...
 delay(1000);
 /* 
  *  La photo est prise si la temperature à l'interieur du colis est trop élévé 
  *  ou s'il semble être perdu(hors zone)
 */ 
 if(temperatureEleve || zoneInconue){
   arduinoUnoInut();
   camInit();
   setRes();
   setColor();
